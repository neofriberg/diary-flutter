...
/// In-memory store for [TrainingType] objects.
class TrainingTypeStore extends ChangeNotifier {
  ...
  Future<void> remove(String id) async {
    ...
    for (final sessionId in sessionIds) {
      sessionStore.clearTrainingType(sessionId);
    }
    notifyListeners();
  }

  TrainingType? getById(String id) =>
      _items.cast<TrainingType?>().firstWhere((e) => e!.id == id, orElse: () => null);
